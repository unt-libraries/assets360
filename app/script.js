  ...
  $(search_btn).each(function() {
    ...
    var article_findit = false;
		$("#ArticleCL").each(function() {
			if ($.trim($(this).text())) {
        article_findit = true;
        var findit_html = "<img src=\"https://gitcdn.link/repo/unt-libraries/assets360/v2.0.1/assets/images/find-it-round.png\" alt=\"FIND IT\" /> Go to Article";
      ...
      if (!article_findit) {
        var journal_html = "<img src=\"https://gitcdn.link/repo/unt-libraries/assets360/v2.0.1/assets/images/find-it-round.png\" alt=\"FIND IT\" /> " + journal_html;
        $(this).addClass("find-it");
        $(this).parent().attr("width", "25%");
      }
